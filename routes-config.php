...
return array(
	...
	// places
	new Route("/api/places", ApiPlacesController::class, "getPlaces", Method::GET),
	new Route("/api/places", ApiPlacesController::class, "addPlace", Method::POST),
	new Route("/api/places/:city", ApiPlacesController::class, "removePlace", Method::DELETE),
	// forecast
